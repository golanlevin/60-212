...
* 3.5. Color Relativity

Due **Monday** September 14:

* 3.6. 60-30-10 Composition
...
(*10%, 40 minutes*) **Read** the following two articles by Monday September 7: 
...
*Now*: In the Discord channel, `#31-color-readings`, in your own voice, **write** a sentence of reflection about something that you found interesting or helpful from these readings. 
...
*Now*: In the Discord channel, `#32-color-explorers`, in your own voice, **write** a sentence of reflection about something that you found interesting or helpful from interacting with these tools. 
