...
1. [***30 minutes***] Please **complete** the following administrative tasks:
	...
	* [*15 minutes*] **Review** the [Syllabus](https://github.com/golanlevin/60-212/blob/main/2025/syllabus/60-212_syllabus_fall2025.md) carefully, and **complete** the [**Welcome Form & Exit Ticket**](https://forms.gle/qa1upyvUXWk1dWra6).
...
4. [***60 minutes***] **Complete** the following four mini-assignments in our [OpenProcessing classroom](https://openprocessing.org/class/100952#/). These are not particularly 'creative' projects; the purpose of these exercises is to help me assess your preparedness and baseline level of programming skill.
   * [*5 minutes*] **Do** [Iteration: Transitioning Rectangles](https://openprocessing.org/class/93074/#/c/93123)
   * [*10 minutes*] **Do** [Nested Iteration & Randomness: Grid, Interrupted]()
   * [*15 minutes*] **Do** [Transformations + Functional Abstraction: Critter Stamps]()
   * [*30 minutes*] **Do** [Array of (Animating) Objects: Ripples]()
